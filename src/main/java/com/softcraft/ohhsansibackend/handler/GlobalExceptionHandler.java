...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleValidationException(MethodArgumentNotValidException ex,
        ...
        ErrorDetails errorDetails = new ErrorDetails(HttpStatus.BAD_REQUEST.value(), "Validacion fallida",
    ...
    public ResponseEntity<Map<String, Object>> handleResourceNotFoundException(ResourceNotFoundException ex,
        ...
        response.put("details", "uri=" + RequestContextHolder.currentRequestAttributes()
                .getAttribute("javax.servlet.forward.request_uri", RequestAttributes.SCOPE_REQUEST));
        response.put("errors", null);
        return new ResponseEntity<>(response, HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(ParticipanteNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleParticipanteNotFoundException(ParticipanteNotFoundException ex,
            WebRequest request) {
        Map<String, Object> response = new HashMap<>();
        response.put("statusCode", HttpStatus.NOT_FOUND.value());
        response.put("message", ex.getMessage());
    ...
    public ResponseEntity<Map<String, Object>> handleIncorrectResultSizeDataAccessException(
